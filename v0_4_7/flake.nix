{
  ...
  inputs.src-nimhdf5-v0_4_7.flake = false;
  inputs.src-nimhdf5-v0_4_7.ref   = "refs/tags/v0.4.7";
  inputs.src-nimhdf5-v0_4_7.owner = "Vindaar";
  inputs.src-nimhdf5-v0_4_7.repo  = "nimhdf5";
  inputs.src-nimhdf5-v0_4_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimhdf5-v0_4_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimhdf5-v0_4_7";
